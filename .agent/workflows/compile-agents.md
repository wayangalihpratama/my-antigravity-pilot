---
description: Utility workflow to bundle the .agent directory into a single text artifact for external LLMs (e.g. Custom GPTs).
---
...
1. Crawl all files in `.agent/rules/`, `.agent/skills/`, and `.agent/workflows/`.

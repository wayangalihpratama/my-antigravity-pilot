...
## Purpose
Finalize the feature by committing verified code using the **Conventional Commits** standard and ensuring perfect alignment with the project's documentation and sprint planning for the FastAPI AI Stack.
...
4. **Atomic Commit Strategy**: Analyze the changed files. Determine if the changes should be split into multiple atomic commits (e.g., separating logic from docs). Propose a split plan to the user.

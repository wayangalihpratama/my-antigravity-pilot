...
- **Patterns:** Locate similar implementations (e.g., existing AI workflows, services) to ensure consistency.
...
- **Technical Constraints:** Limitations of the current stack (FastAPI, AI Services).
...
List specific AI technologies and internal patterns that need verification.

### 6. Technical & Documentation Research
Perform targeted queries for the project's specific versions:
- Use **Web Search** for exact versions (e.g., "Pydantic v2 patterns", "FastAPI AI integration").
...
- **Internal References:** "Follows pattern found in `backend/routers/ai_agent.py`."

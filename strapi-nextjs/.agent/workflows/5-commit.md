...
## Purpose
Finalize the feature by committing verified code using the **Conventional Commits** standard and ensuring perfect alignment with the project's documentation and sprint planning for Strapi and Next.js.
